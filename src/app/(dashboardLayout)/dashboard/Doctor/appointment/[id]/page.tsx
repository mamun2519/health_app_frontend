            ...
            {/* <div className="  lg:flex gap-5">
              <div className="w-full border lg:h-56 h-[420px] rounded  lg:flex gap-5 p-5   shadow bg-[#30029010]">
                ...
                <div className="  lg:w-[19vw] lg:mt-2 mt-3">
                  <h3 className=" text-xl  font-bold">{`Dr, ${data?.user?.profile?.first_name} ${data?.user?.profile?.last_name}`}</h3>
                ...
                <div className=" ">
                  ...
                  <div className=" mt-8">
                    ...
                    <div className=" grid  grid-cols-2 border-b pb-2 mt-3">
                      ...
                      <span>{data?.doctor.total_patient}</span>
                    </div>
                    <div className=" grid  grid-cols-2 border-b pb-2 mt-3">
                ...
                <div className=" ">
                  ...
                  <div className=" mt-8">
                    <div className=" grid  grid-cols-2 border-b  pb-2 mt-3">
                      ...
                      <span>{` ${data?.user?.profile?.first_name} ${data?.user?.profile?.last_name}`}</span>
                    </div>
                    <div className=" grid  grid-cols-2 border-b  pb-2 mt-3">
