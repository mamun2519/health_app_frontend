...
import { useUserServiceReviewQuery } from "@/redux/api/doctorServiceApi";
...
const DoctorReview = () => {
  ...
  //doctor service review
  // const { data } = useUserServiceReviewQuery({...query});
  ...
  return (
    <div>
      <h3 className=" mt-5 text-2xl">My Donor Review</h3>
      <div className="mt-8">
