    ...
    <div className="max-w-7xl mx-auto px-4 lg:px-0 py-10  psb-20">
        ...
        <div className="w-full border lg:h-56  rounded  lg:flex gap-5 p-5  relative shadow bg-[#30029010] ">
          ...
          <div className="  lg:w-[19vw] lg:mt-2 mt-3">
            ...
            <p className=" mt-1 text-gray-800">
              Division At {donor?.profile?.present_Address?.district}
            </p>
            <p className=" mt-1 text-gray-800">
              Join {convertDate(donor?.updatedAt)}
            </p>
            <p className=" mt-1 text-gray-800">
              Already {donor?.bloodDonor?.total_donnet} people Dononet completed
            </p>
            <p className=" mt-1 text-gray-800">Status {donor?.status}</p>
          </div>
          ...
          <div className=" ">
            ...
            <div className=" mt-8">
              <div className=" grid  grid-cols-2 border-b  pb-2 mt-3">
                <span>Full Name</span>
                <span>{`${donor?.profile?.first_name} ${donor?.profile?.last_name}`}</span>
              </div>
              <div className=" grid  grid-cols-2 border-b  pb-2 mt-3">
                <span>Email</span>
              ...
              <div className=" grid  grid-cols-2 border-b pb-2 mt-3">
                <span>Gender</span>
                <span>{donor?.profile?.gender}</span>
              </div>
              <div className=" grid  grid-cols-2 border-b pb-2 mt-3">
                <span>District</span>
                <span>{donor?.profile?.present_Address?.district}</span>
              </div>
              ...
              <div className=" grid  grid-cols-2 border-b pb-2 mt-3">
                ...
                <span>{donor?.profile?.date_of_birth}</span>
              </div>
              <div className=" grid  grid-cols-2 border-b pb-2 mt-3">
                <span>Address</span>
                <span>{donor?.profile?.present_Address?.address}</span>
              </div>
              <div className=" grid  grid-cols-2 border-b pb-2 mt-3">
                <span>Total Donation</span>
                <span>{donor?.bloodDonor?.total_donnet} People</span>
              </div>
              <div className=" grid  grid-cols-2 border-b pb-2 mt-3">
      ...
      <div className="">
        <div className="lg:w-80  border p-5 rounded    lg:absolute  right-[313px] mt-5  h-[360px]  shadow  bg-[#30029010] ">
          ...
          <div className=" pl-10">
            <div className=" w-60 h-28 border bg-white rounded-3xl  relative mt-2  ">
